...
class TestCheckOnline:
    ...
    def test_undetectable_without_server(self, _napcat_dir):
        _write_cfg(_napcat_dir, "1", [])
        assert w.check_online("1") is None
